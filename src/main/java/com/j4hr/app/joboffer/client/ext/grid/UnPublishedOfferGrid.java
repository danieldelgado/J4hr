...
public class UnPublishedOfferGrid extends AbstractJobOfferGridView {
	...
	protected ListStore<JobOfferData> getListJobOfferData() {
		...
		jobOfferRPCService.loadAllUnPublishedOffersUIAction(new AsyncCallback<List<JobOfferData>>(){
			@Override
	...
	protected String getGridTitle() {
		return "UnPublished Job Offer's list";
	}
}
